...
public class MouseEventDemo extends javax.swing.JFrame {
    ...
    private void jTextArea1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTextArea1MouseClicked
        ...
        if(evt.getModifiers() == InputEvent.BUTTON1_MASK){
            jTextArea1.append("Left is clicked " +evt.getPoint().toString() + " \n");  //point lay vi tri toa do
        }
        if(evt.getModifiers() == InputEvent.BUTTON2_MASK){
            jTextArea1.append("Middle is clicked \n");
        }
        if(evt.getModifiers() == InputEvent.BUTTON3_MASK){
            jTextArea1.append("Right is clicked (" + evt.getPoint().x + ", " + evt.getPoint().y + ")\n");
        }
//        if(MouseEvent. ...)
