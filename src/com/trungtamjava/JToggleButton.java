 ...
 * @author ASUS
 */
public class JToggleButton extends javax.swing.JFrame {

    /**
     * Creates new form JToggleButton
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JToggleButton.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JToggleButton().setVisible(true);
            }
        });
    }
